// Configurações
const startDate = new Date('2022-05-15T00:00:00-03:00'); // Horário de Brasília (UTC-3)
...
function updateCounter() {
    // Obter horário atual em UTC e depois converter para Brasília (UTC-3)
    const now = new Date();
    ...
    const diff = brasiliaTime - startDate;
